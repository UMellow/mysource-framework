...
<link rel="shortcut icon" href="<%=path%>/Nice-admin/img/favicon.png">
...
<!-- bootstrap theme -->
<link
	href="<%=path%>/js/bootstrap/bootstrap-3.3.4-dist/css/bootstrap-theme.css"
	rel="stylesheet">
<!--external css-->
<!-- font icon -->
<link href="<%=path%>/js/Nice-admin/css/elegant-icons-style.css"
	rel="stylesheet" />
<link href="<%=path%>/js/Nice-admin/css/font-awesome.min.css"
	rel="stylesheet" />
<!-- Custom styles -->
<link href="<%=path%>/js/Nice-admin/css/style.css" rel="stylesheet">
<link href="<%=path%>/js/Nice-admin/css/style-responsive.css"
	rel="stylesheet" />
</head>
