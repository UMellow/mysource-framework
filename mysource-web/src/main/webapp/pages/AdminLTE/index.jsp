...
<head>
	...
	<!-- Bootstrap 3.3.6 -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/bootstrap/css/bootstrap.min.css">
	<!-- Font Awesome -->
	...
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/dist/css/skins/_all-skins.min.css">
	<!-- iCheck -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/plugins/iCheck/flat/blue.css">
	<!-- Morris chart -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/plugins/morris/morris.css">
	<!-- jvectormap -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
	<!-- Date Picker -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/plugins/datepicker/datepicker3.css">
	<!-- Daterange picker -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/plugins/daterangepicker/daterangepicker.css">
	<!-- bootstrap wysihtml5 - text editor -->
	<link rel="stylesheet" href="${ctx}/js/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="${ctx}/js/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${ctx}/js/AdminLTE/dist/img/user3-128x128.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${ctx}/js/AdminLTE/dist/img/user4-128x128.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="${ctx}/js/AdminLTE/dist/img/user2-160x160.jpg" class="user-image"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="${ctx}/js/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle"
									alt="User Image">
					...
					<section class="col-lg-7 connectedSortable">
						...
						<div class="box box-success">
							...
							<div class="box-body chat" id="chat-box">
								<!-- chat item -->
								<div class="item">
									<img src="${ctx}/js/AdminLTE/dist/img/user4-128x128.jpg" alt="user image"
										class="online">
								...
								<!-- chat item -->
								<div class="item">
									<img src="${ctx}/js/AdminLTE/dist/img/user3-128x128.jpg" alt="user image"
										class="offline">
								...
								<!-- chat item -->
								<div class="item">
									<img src="${ctx}/js/AdminLTE/dist/img/user2-160x160.jpg" alt="user image"
										class="offline">
	...
	<!-- jQuery 2.2.3 -->
	<script src="${ctx}/js/AdminLTE/plugins/jQuery/jquery-2.2.3.min.js"></script>
	<!-- jQuery UI 1.11.4 -->
  ...
  $.widget.bridge('uibutton', $.ui.button);
	...
	<!-- Bootstrap 3.3.6 -->
	<script src="${ctx}/js/AdminLTE/bootstrap/js/bootstrap.min.js"></script>
	<!-- Morris.js charts -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
	<script src="${ctx}/js/AdminLTE/plugins/morris/morris.min.js"></script>
	<!-- Sparkline -->
	<script src="${ctx}/js/AdminLTE/plugins/sparkline/jquery.sparkline.min.js"></script>
	<!-- jvectormap -->
	<script src="${ctx}/js/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="${ctx}/js/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<!-- jQuery Knob Chart -->
	<script src="${ctx}/js/AdminLTE/plugins/knob/jquery.knob.js"></script>
	<!-- daterangepicker -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
	<script src="${ctx}/js/AdminLTE/plugins/daterangepicker/daterangepicker.js"></script>
	<!-- datepicker -->
	<script src="${ctx}/js/AdminLTE/plugins/datepicker/bootstrap-datepicker.js"></script>
	<!-- Bootstrap WYSIHTML5 -->
	<script src="${ctx}/js/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
	<!-- Slimscroll -->
	<script src="${ctx}/js/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js"></script>
	<!-- FastClick -->
	<script src="${ctx}/js/AdminLTE/plugins/fastclick/fastclick.js"></script>
	<!-- AdminLTE App -->
	<script src="${ctx}/js/AdminLTE/dist/js/app.min.js"></script>
	<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
	<script src="${ctx}/js/AdminLTE/dist/js/pages/dashboard.js"></script>
